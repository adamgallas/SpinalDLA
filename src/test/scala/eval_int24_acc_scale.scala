...
import xilinx.DSP48E2IntArithmetic.standalone.int24_acc_scale

import scala.language.postfixOps
import scala.util.Random

object eval_int24_acc_scale extends App {

  SpinalVerilog(new int24_acc_scale)
